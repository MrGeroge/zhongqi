  ...
  <section id="container" class="">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post" action="<%=basePath%>Admin/Page?action=Update">
							      <input value="${uid}" name="uid" type="hidden">
							      <input value="${catalog}" name="catalog" type="hidden">
							      <input value="${page.id}" name="id" type="hidden">
                                  <div class="form-group">
                                      <label class="col-sm-2 col-sm-2 control-label">页名称:</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" id="pageName" name="pageName" value="${page.pageName}">
                                      </div>
                                  </div>
                                  <div class="form-group">
    ...
    <script>
          ...
          $('#btn-back').live('click', function (e) {
        	  window.location.href="<%=basePath%>Admin/Page?catalog=${catalog}";
          });
    </script>
