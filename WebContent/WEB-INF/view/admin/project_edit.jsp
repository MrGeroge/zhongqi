                  ...
                  <div class="col-lg-9">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" method="post" action="<%=basePath%>Admin/Project?action=UpdateProject">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                         <input type="text" name="address" id="address" class="form-control" value="${project.address}"/>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                           <input type="text" name="finishDate" id="finishDate" class="form-control" value="${project.finishDate}"/>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label col-sm-2">封面</label>
                                      <div class="col-sm-10">
                                          <input class="ke-input-text" type="text" id="url" value="" readonly="readonly" name="cover" class="form-control" value="${project.cover}"/> <input type="button" id="uploadButton" value="Upload" />
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <select class="form-control m-bot15" id="catalog" name="catalog">
                                              <c:forEach var="catalog" items="${catalogs}">
                                                  <option value="${catalog.id}" ${catalog.id==project.catalog.id?"selected='selected'":""}>${catalog.name}</option>
                                              </c:forEach>
                                          </select>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                           <textarea rows="" cols="" name="description" id="description" class="form-control" rows="10" cols="20">${project.description}</textarea>
