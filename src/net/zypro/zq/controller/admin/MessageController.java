...
public class MessageController extends GenericServlet{
private static String basePath;
			   ...
			   HttpServletResponse response)
	{
		...
		request.setAttribute("messages", aManager.findAllMessages());
		GoToPage("/WEB-INF/view/admin/message_list.jsp", request, response);		
	}
	   ...
	   HttpServletResponse response)
	{
		...
		AdminManager aManager=ServiceFactory.getAdminManager();
		aManager.deleteMessage(Integer.parseInt(id));
	}
